      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 lg:px-8 py-16 lg:py-24">
          ...
          <p className="text-[18px] text-fg-muted leading-relaxed max-w-2xl">
            We're an IT consultancy based in Andover, Hampshire. We help small and mid-sized business
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.step} className="flex gap-4">
                    <span className="font-mono text-[12px] font-semibold text-brand mt-0.5 flex-shrink-0 w-6">
                      {item.step}
                    </span>
                    <div>
